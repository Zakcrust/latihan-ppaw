			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('mahasiswa/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<form action="<?php base_url('mahasiswa/edit') ?>" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="unx" value="<?php echo $mahasiswa->mahasiswa_unx?>" />

							<div class="form-group">
								<label for="name">NIM*</label>
								<input class="form-control <?php echo form_error('nim') ? 'is-invalid':'' ?>"
								 type="number" name="nim" placeholder="Kode" value="<?php echo $mahasiswa->nim ?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('mahasiswa_nama') ? 'is-invalid':'' ?>"
								 type="text" name="mahasiswa_nama" placeholder="Deskripsi" value="<?php echo $mahasiswa->mahasiswa_nama ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tanggal_lahir') ? 'is-invalid':'' ?>"
								 type="date" min="0" max="4" name="tanggal_lahir" placeholder="tanggal_lahir" value="<?php echo $mahasiswa->tanggal_lahir ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<select name="jenis_kelamin" id="jenis_kelamin" placeholder="jenis_kelamin" value = "<?php echo $mahasiswa->jenis_kelamin ?>">
